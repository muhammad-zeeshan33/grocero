      ...
      <div className='flex flex-col'>
        <div className='  flex gap-10 justify-evenly p-[40px] font-Poppins '>
          <div className='bg-white rounded p-5 flex items-start shadow w-full '>
            <div className='text-gray-700 '>
              <svg
                ...
                className='icon icon-tabler icon-tabler-dashboard ml-2'
                width={32}
                height={32}
                viewBox='0 0 24 24'
                strokeWidth='1.5'
            ...
            <div className='pl-3 pr-10 mt-1'>
              <h3 className='font-medium leading-4 text-gray-800  text-2xl'>
                Total Orders
              </h3>
              <div className='flex items-end mt-4'>
                <h2 className='text-indigo-700 dark:text-indigo-600 text-3xl leading-normal font-medium'>
                  2,330
                </h2>
              </div>
              <div className='flex items-center mt-5'>
                ...
                <p className='text-green-400 text-lg tracking-wide font-bold leading-normal pl-1'>
                  7.2% Increase
                </p>
              </div>
            </div>
          ...
          <div className='bg-white  rounded p-5 flex items-start shadow w-full'>
            ...
            <div className='pl-3 pr-10 mt-1'>
              ...
              <div className='flex items-center mt-5'>
                ...
                <p className='text-red-400 text-lg  tracking-wide font-bold leading-normal pl-1'>
                  3.5% Decrease
                </p>
              </div>
            </div>
          ...
          <div className='bg-white  rounded p-5 flex items-start shadow w-full'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              className='icon icon-tabler icon-tabler-dashboard text-gray-700 '
              width={32}
              height={32}
              viewBox='0 0 24 24'
              strokeWidth='1.5'
