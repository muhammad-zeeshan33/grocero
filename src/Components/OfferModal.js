    ...
    let modalContent = (
      <form className='space-y-6' onSubmit={(e) => this.addOfferHandler(e)}>
        ...
        {this.state.uploading && (
          <small className='text-blue-400 mb-3'>
        ...
        <div className='flex justify-around'>
          <button
            ...
            className='text-white bg-[#363740] border  font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2'
          >
          ...
          <button
            ...
            className='text-[#333] bg-white  border border-[#333] font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 '
          >
            Discard
          </button>
        </div>
