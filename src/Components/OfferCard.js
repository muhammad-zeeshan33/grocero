            ...
            <div className={!deleteModal ? 'hidden':"fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex items-center justify-center font-Poppins"}>
                    <div className="bg-white p-2 rounded w-4/12">                        
                        <div className="flex flex-col items-center pb-10 text-colortxt text-center">                                                    
                            <h5 className="mb-1 text-xl font-medium mt-3">Are you sure you want to delete {props.title}?</h5>   
                            <div className='d-flex'>
                                ...
                                <button onClick={deleteModalToggler} disabled={loading} className="text-red-700 bg-white  border border-red-700 font-medium rounded-lg text-sm px-5 ml-3 py-2.5  mb-2">Discard</button> 
                            </div>         
                        </div>                            
                    </div>
                </div>    
