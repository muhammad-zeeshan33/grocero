...
export default function Product_display(props) {
    ...
    let modalContent = (
        ...
        <div className="mt-5 mb-2 flex">
                ...
                <input type="file" onChange={(e) => imgChangeHandler(e)} id="myfile" name="myfile" className="ml-2" />                        
            </div>
    ...
    return (
        <>
                    ...
                    <div className="bg-[#FFF5F9] hover:bg-[#ffe9f2]   ">
                        ...
                        <div className="p-4">
                            <div className="flex justify-between items-center">
                                ...
                                <p className="text-xs text-gray-600 pl-5"><Moment fromNow>{props.createdAt}</Moment></p>
                            </div>
                            <p className="text-xs text-gray-600 mt-2">{props.desc}</p>
                            <div className="flex items-center justify-between py-4">
                                <h2 className="text-[#F27AAC] text-xs font-medium">Category: {props.category}</h2>
                            ...
                            <div className="flex items-center justify-between ">
                                ...
                                <button 
                                    ...
                                    onClick={handleclick} ><EditIcon /><label>Edit</label>
                                </button>
                                <button 
                                    type="button" 
                                    onClick={deleteModalToggler}
                                    class=" bg-white  border border-red-600 font-medium rounded-lg text-sm px-3 py-2  space-x-1 text-red-500 " ><label>Delete</label>                                    
                                </button></div>
                        </div>
            ...
            <div className={!model ? 'hidden':"fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex items-center justify-center font-Poppins"}>
                ...
                <div className={!deleteModel ? 'hidden':"fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex items-center justify-center font-Poppins"}>
                    <div className="bg-white p-2 rounded w-4/12">                        
                        <div class="flex flex-col items-center pb-10 text-colortxt text-center">                                                    
                            <h5 class="mb-1 text-xl font-medium mt-3">Are you sure you want to delete {props.name}?</h5>   
